...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/subscriptions/master/_listings/eu-vat-api/apis.md
...
- name: VAT API - Check api requests remaining on current subscription plan
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/subscriptions/master/_listings/eu-vat-api/usagecheck-get-openapi.md
- name: VAT API - Check api requests remaining on current subscription plan
  x-api-slug: usagecheck-get
  description: Check api requests remaining on current subscription plan.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/vatapi-logo.png
