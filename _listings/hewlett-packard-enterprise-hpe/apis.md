...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/subscriptions/master/_listings/hewlett-packard-enterprise-hpe/apis.md
...
- name: HPE OneSphere API - Get Onboarding Azure Subscriptions
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/subscriptions/master/_listings/hewlett-packard-enterprise-hpe/onboardingazuresubscriptions-get-openapi.md
- name: HPE OneSphere API - Patch Onboarding Azure Subscriptions Subscriptionid
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/subscriptions/master/_listings/hewlett-packard-enterprise-hpe/onboardingazuresubscriptionssubscriptionid-patch-openapi.md
- name: HPE OneSphere API - Patch Onboarding Azure Subscriptions Subscriptionid
  x-api-slug: onboardingazuresubscriptionssubscriptionid-patch
  description: Updates a subscription
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/HPE-logo.png
