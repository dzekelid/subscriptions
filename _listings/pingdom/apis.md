...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/subscriptions/master/_listings/pingdom/apis.md
...
- name: Reports API - Get Email Report Subscription List
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/subscriptions/master/_listings/pingdom/apiversionreports-email-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/subscriptions/master/_listings/pingdom/apiversionreports-email-get-openapi.md
- name: Reports API - Get Email Report Subscription List
  x-api-slug: apiversionreports-email-get
  description: Returns a list of email report subscriptions.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/456-pingdom.jpg
