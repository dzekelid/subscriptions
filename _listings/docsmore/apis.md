...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/subscriptions/master/_listings/docsmore/apis.md
...
- name: Docsmore API 2.1 - Subscribe To Webhook
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/subscriptions/master/_listings/docsmore/apiwebhooksubscribe-post-openapi.md
- name: Docsmore API 2.1 - Subscribe To Webhook
  x-api-slug: apiwebhooksubscribe-post
  description: |-
    Make sure you have a unique payload URL every time you use this api call to register your webhook. Unable to do so will result in webhook registration denial.
